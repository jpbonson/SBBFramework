...
def calculate_hand_potential(current_hole_cards, board_cards, round_id, full_deck, hole_cards_based_on_equity):
    """
    ...
    opponent_cards_combinations = list(hole_cards_based_on_equity)
    indices = []
