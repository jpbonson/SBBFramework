...
class OpponentModel():
    ...
    inputs[3] = opponent long-term tight/loose
    inputs[4] = opponent long-term passive/aggressive
    ...
    INPUTS = ['opp last action', 'opp hand agressiveness','opp agressiveness', 'opp tight/loose', 'opp passive/aggressive']
