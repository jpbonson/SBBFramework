...
create_chart <- function(chart_name, score_name, score_index, diversity_name, diversity_index) {
...
create_chart("training_vs_diversity1.gif", "Training Score", 1, "Diversity 1", 3);
create_chart("training_vs_diversity2.gif", "Training Score", 1, "Diversity 2", 4);
create_chart("test_vs_diversity1.gif", "Test Score", 2, "Diversity 1", 3);
create_chart("test_vs_diversity2.gif", "Test Score", 2, "Diversity 2", 4);
create_chart("train_vs_test.gif", "Training Score", 1, "Test Score", 2);
create_chart("diversity1_vs_diversity2.gif", "Diversity 1", 3, "Diversity 2", 4);